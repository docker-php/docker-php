...
class ContainersIdJsonResponse200StateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_25\\Model\\ContainersIdJsonResponse200State') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\ContainersIdJsonResponse200State) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\ContainersIdJsonResponse200State();
