...
class InfoGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_25\\Model\\InfoGetResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\InfoGetResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\InfoGetResponse200();
        ...
        if (property_exists($data, 'Plugins')) {
            $object->setPlugins($this->denormalizer->denormalize($data->{'Plugins'}, 'Docker\\API\\V1_25\\Model\\InfoGetResponse200Plugins', 'json', $context));
        }
        ...
        if (property_exists($data, 'RegistryConfig')) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data->{'RegistryConfig'}, 'Docker\\API\\V1_25\\Model\\InfoGetResponse200RegistryConfig', 'json', $context));
        }
