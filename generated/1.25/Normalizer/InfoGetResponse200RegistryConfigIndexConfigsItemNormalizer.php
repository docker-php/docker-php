...
class InfoGetResponse200RegistryConfigIndexConfigsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_25\\Model\\InfoGetResponse200RegistryConfigIndexConfigsItem') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\InfoGetResponse200RegistryConfigIndexConfigsItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\InfoGetResponse200RegistryConfigIndexConfigsItem();
