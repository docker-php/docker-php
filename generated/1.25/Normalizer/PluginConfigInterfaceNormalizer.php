...
class PluginConfigInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_25\\Model\\PluginConfigInterface') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\PluginConfigInterface) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\PluginConfigInterface();
        if (property_exists($data, 'Types')) {
            $values = [];
            foreach ($data->{'Types'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_25\\Model\\PluginInterfaceType', 'json', $context);
            }
