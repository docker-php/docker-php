...
class PluginSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_25\\Model\\PluginSettings' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\PluginSettings) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\PluginSettings();
        if (property_exists($data, 'Mounts')) {
            $values = [];
            foreach ($data->{'Mounts'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_25\\Model\\PluginMount', 'json', $context);
            }
        ...
        if (property_exists($data, 'Devices')) {
            ...
            foreach ($data->{'Devices'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\API\\V1_25\\Model\\PluginDevice', 'json', $context);
            }
