...
class ResourcesBlkioWeightDeviceItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_25\\Model\\ResourcesBlkioWeightDeviceItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\ResourcesBlkioWeightDeviceItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\ResourcesBlkioWeightDeviceItem();
