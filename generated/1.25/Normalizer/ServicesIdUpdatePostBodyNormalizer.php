...
class ServicesIdUpdatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_25\\Model\\ServicesIdUpdatePostBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\ServicesIdUpdatePostBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\ServicesIdUpdatePostBody();
        ...
        if (property_exists($data, 'TaskTemplate')) {
            $object->setTaskTemplate($this->denormalizer->denormalize($data->{'TaskTemplate'}, 'Docker\\API\\V1_25\\Model\\TaskSpec', 'json', $context));
        }
        if (property_exists($data, 'Mode')) {
            $object->setMode($this->denormalizer->denormalize($data->{'Mode'}, 'Docker\\API\\V1_25\\Model\\ServiceSpecMode', 'json', $context));
        }
        if (property_exists($data, 'UpdateConfig')) {
            $object->setUpdateConfig($this->denormalizer->denormalize($data->{'UpdateConfig'}, 'Docker\\API\\V1_25\\Model\\ServiceSpecUpdateConfig', 'json', $context));
        }
        if (property_exists($data, 'Networks')) {
            $values_1 = [];
            foreach ($data->{'Networks'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_25\\Model\\ServiceSpecNetworksItem', 'json', $context);
            }
            $object->setNetworks($values_1);
        }
        if (property_exists($data, 'EndpointSpec')) {
            $object->setEndpointSpec($this->denormalizer->denormalize($data->{'EndpointSpec'}, 'Docker\\API\\V1_25\\Model\\EndpointSpec', 'json', $context));
        }
