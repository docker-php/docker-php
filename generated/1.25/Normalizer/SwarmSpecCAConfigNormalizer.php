...
class SwarmSpecCAConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_25\\Model\\SwarmSpecCAConfig' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_25\Model\SwarmSpecCAConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_25\Model\SwarmSpecCAConfig();
        ...
        if (property_exists($data, 'ExternalCAs')) {
            ...
            foreach ($data->{'ExternalCAs'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_25\\Model\\SwarmSpecCAConfigExternalCAsItem', 'json', $context);
            }
