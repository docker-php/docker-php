...
class ContainerResource extends Resource
{
    ...
    /**
     * @param \Docker\API\V1_25\Model\ContainersCreateBody $body       Container to create
     * @param array                                        $parameters {
     *
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersCreateResponse201|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerCreate(\Docker\API\V1_25\Model\ContainersCreateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersCreateResponse201', 'json');
            }
            if ('400' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersIdJsonResponse200|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerInspect($id, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersIdJsonResponse200', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersIdTopResponse200|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerTop($id, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersIdTopResponse200', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersIdChangesResponse200Item[]|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerChanges($id, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersIdChangesResponse200Item[]', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     *
     * @param string                                         $id         ID or name of the container
     * @param \Docker\API\V1_25\Model\ContainersIdUpdateBody $update
     * @param array                                          $parameters List of parameters
     * @param string                                         $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersIdUpdateResponse200|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerUpdate($id, \Docker\API\V1_25\Model\ContainersIdUpdateBody $update, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersIdUpdateResponse200', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersIdWaitResponse200|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerWait($id, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersIdWaitResponse200', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_25\Model\ContainersIdArchiveResponse400|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerGetArchive($id, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            ...
            if ('400' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersIdArchiveResponse400', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\ContainersPruneResponse200|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function containerPrune($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ContainersPruneResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\ErrorResponse', 'json');
            }
