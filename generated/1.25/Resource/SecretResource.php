...
class SecretResource extends Resource
{
    ...
    /**
     * @param \Docker\API\V1_25\Model\SecretsCreateBody $body
     * @param array                                     $parameters List of parameters
     * @param string                                    $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_25\Model\SecretsCreateResponse201|\Docker\API\V1_25\Model\ErrorResponse
     */
    public function secretCreate(\Docker\API\V1_25\Model\SecretsCreateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_25\\Model\\SecretsCreateResponse201', 'json');
            }
