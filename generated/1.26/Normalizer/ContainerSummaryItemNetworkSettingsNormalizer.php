...
class ContainerSummaryItemNetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_26\\Model\\ContainerSummaryItemNetworkSettings') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\ContainerSummaryItemNetworkSettings) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\ContainerSummaryItemNetworkSettings();
