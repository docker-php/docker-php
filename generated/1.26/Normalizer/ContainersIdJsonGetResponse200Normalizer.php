...
class ContainersIdJsonGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_26\\Model\\ContainersIdJsonGetResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\ContainersIdJsonGetResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\ContainersIdJsonGetResponse200();
        ...
        if (property_exists($data, 'State')) {
            $object->setState($this->denormalizer->denormalize($data->{'State'}, 'Docker\\API\\V1_26\\Model\\ContainersIdJsonGetResponse200State', 'json', $context));
        }
        ...
        if (property_exists($data, 'HostConfig')) {
            $object->setHostConfig($this->denormalizer->denormalize($data->{'HostConfig'}, 'Docker\\API\\V1_26\\Model\\HostConfig', 'json', $context));
        }
        if (property_exists($data, 'GraphDriver')) {
            $object->setGraphDriver($this->denormalizer->denormalize($data->{'GraphDriver'}, 'Docker\\API\\V1_26\\Model\\GraphDriver', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_26\\Model\\MountPoint', 'json', $context);
            }
            $object->setMounts($values_1);
        }
        if (property_exists($data, 'Config')) {
            $object->setConfig($this->denormalizer->denormalize($data->{'Config'}, 'Docker\\API\\V1_26\\Model\\Config', 'json', $context));
        }
        if (property_exists($data, 'NetworkSettings')) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data->{'NetworkSettings'}, 'Docker\\API\\V1_26\\Model\\NetworkConfig', 'json', $context));
        }
