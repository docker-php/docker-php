...
class CreateImageInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_26\\Model\\CreateImageInfo' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\CreateImageInfo) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\CreateImageInfo();
