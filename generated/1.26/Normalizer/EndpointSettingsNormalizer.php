...
class EndpointSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_26\\Model\\EndpointSettings' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\EndpointSettings) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\EndpointSettings();
        if (property_exists($data, 'IPAMConfig')) {
            $object->setIPAMConfig($this->denormalizer->denormalize($data->{'IPAMConfig'}, 'Docker\\API\\V1_26\\Model\\EndpointSettingsIPAMConfig', 'json', $context));
        }
