...
class ImageDeleteResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_26\\Model\\ImageDeleteResponse') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\ImageDeleteResponse) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\ImageDeleteResponse();
