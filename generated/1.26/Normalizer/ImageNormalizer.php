...
class ImageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_26\\Model\\Image') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\Image) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\Image();
        ...
        if (property_exists($data, 'ContainerConfig')) {
            $object->setContainerConfig($this->denormalizer->denormalize($data->{'ContainerConfig'}, 'Docker\\API\\V1_26\\Model\\Config', 'json', $context));
        }
        ...
        if (property_exists($data, 'RootFS')) {
            $object->setRootFS($this->denormalizer->denormalize($data->{'RootFS'}, 'Docker\\API\\V1_26\\Model\\ImageRootFS', 'json', $context));
        }
