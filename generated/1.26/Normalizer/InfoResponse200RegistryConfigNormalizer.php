...
class InfoResponse200RegistryConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_26\\Model\\InfoResponse200RegistryConfig') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\InfoResponse200RegistryConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\InfoResponse200RegistryConfig();
        if (property_exists($data, 'IndexConfigs')) {
            $values = new \ArrayObject([], \ArrayObject::ARRAY_AS_PROPS);
            foreach ($data->{'IndexConfigs'} as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_26\\Model\\InfoResponse200RegistryConfigIndexConfigsItem', 'json', $context);
            }
