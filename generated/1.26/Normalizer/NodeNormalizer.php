...
class NodeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\Node) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\Node();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_26\\Model\\NodeSpec', 'json', $context));
        }
        if (property_exists($data, 'Description')) {
            $object->setDescription($this->denormalizer->denormalize($data->{'Description'}, 'Docker\\API\\V1_26\\Model\\NodeDescription', 'json', $context));
        }
