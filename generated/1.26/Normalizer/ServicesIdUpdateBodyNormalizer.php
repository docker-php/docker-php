...
class ServicesIdUpdateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_26\\Model\\ServicesIdUpdateBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\ServicesIdUpdateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\ServicesIdUpdateBody();
