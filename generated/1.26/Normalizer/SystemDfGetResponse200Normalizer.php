...
class SystemDfGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_26\\Model\\SystemDfGetResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\SystemDfGetResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\SystemDfGetResponse200();
        ...
        if (property_exists($data, 'Images')) {
            ...
            foreach ($data->{'Images'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_26\\Model\\ImageSummary', 'json', $context);
            }
        ...
        if (property_exists($data, 'Containers')) {
            ...
            foreach ($data->{'Containers'} as $value_1) {
                ...
                foreach ($value_1 as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\API\\V1_26\\Model\\ContainerSummaryItem', 'json', $context);
                }
                $values_1[] = $values_2;
            }
        ...
        if (property_exists($data, 'Volumes')) {
            ...
            foreach ($data->{'Volumes'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\API\\V1_26\\Model\\Volume', 'json', $context);
            }
