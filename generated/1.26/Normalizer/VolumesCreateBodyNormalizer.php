...
class VolumesCreateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_26\\Model\\VolumesCreateBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_26\Model\VolumesCreateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_26\Model\VolumesCreateBody();
