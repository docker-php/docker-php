...
class ServiceResource extends Resource
{
    ...
    /**
     * @param \Docker\API\V1_26\Model\ServicesCreateBody $body
     * @param array                                      $parameters {
     *
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_26\Model\ServicesCreateResponse201|\Docker\API\V1_26\Model\ErrorResponse
     */
    public function serviceCreate(\Docker\API\V1_26\Model\ServicesCreateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_26\\Model\\ServicesCreateResponse201', 'json');
            }
    ...
    /**
     * @param string                                       $id         ID or name of service
     * @param \Docker\API\V1_26\Model\ServicesIdUpdateBody $body
     * @param array                                        $parameters {
     *
     ...
     */
    public function serviceUpdate($id, \Docker\API\V1_26\Model\ServicesIdUpdateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
