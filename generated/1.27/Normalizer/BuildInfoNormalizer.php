...
class BuildInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_27\\Model\\BuildInfo' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\BuildInfo) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\BuildInfo();
        ...
        if (property_exists($data, 'errorDetail')) {
            $object->setErrorDetail($this->denormalizer->denormalize($data->{'errorDetail'}, 'Docker\\API\\V1_27\\Model\\ErrorDetail', 'json', $context));
        }
        ...
        if (property_exists($data, 'progressDetail')) {
            $object->setProgressDetail($this->denormalizer->denormalize($data->{'progressDetail'}, 'Docker\\API\\V1_27\\Model\\ProgressDetail', 'json', $context));
        }
