...
class ContainerSummaryItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_27\\Model\\ContainerSummaryItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\ContainerSummaryItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\ContainerSummaryItem();
        ...
        if (property_exists($data, 'Ports')) {
            ...
            foreach ($data->{'Ports'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_27\\Model\\Port', 'json', $context);
            }
        ...
        if (property_exists($data, 'HostConfig')) {
            $object->setHostConfig($this->denormalizer->denormalize($data->{'HostConfig'}, 'Docker\\API\\V1_27\\Model\\ContainerSummaryItemHostConfig', 'json', $context));
        }
        if (property_exists($data, 'NetworkSettings')) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data->{'NetworkSettings'}, 'Docker\\API\\V1_27\\Model\\ContainerSummaryItemNetworkSettings', 'json', $context));
        }
        if (property_exists($data, 'Mounts')) {
            $values_3 = [];
            foreach ($data->{'Mounts'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\API\\V1_27\\Model\\Mount', 'json', $context);
            }
