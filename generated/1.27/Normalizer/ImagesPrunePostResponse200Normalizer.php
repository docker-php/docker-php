...
class ImagesPrunePostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_27\\Model\\ImagesPrunePostResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\ImagesPrunePostResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\ImagesPrunePostResponse200();
        if (property_exists($data, 'ImagesDeleted')) {
            $values = [];
            foreach ($data->{'ImagesDeleted'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_27\\Model\\ImageDeleteResponse', 'json', $context);
            }
