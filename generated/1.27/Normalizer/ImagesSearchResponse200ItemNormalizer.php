...
class ImagesSearchResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_27\\Model\\ImagesSearchResponse200Item' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\ImagesSearchResponse200Item) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\ImagesSearchResponse200Item();
