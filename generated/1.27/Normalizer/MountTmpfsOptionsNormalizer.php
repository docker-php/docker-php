...
class MountTmpfsOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_27\\Model\\MountTmpfsOptions' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\MountTmpfsOptions) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\MountTmpfsOptions();
