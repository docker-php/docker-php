...
class NodeDescriptionEngineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_27\\Model\\NodeDescriptionEngine') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\NodeDescriptionEngine) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\NodeDescriptionEngine();
        ...
        if (property_exists($data, 'Plugins')) {
            ...
            foreach ($data->{'Plugins'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_27\\Model\\NodeDescriptionEnginePluginsItem', 'json', $context);
            }
