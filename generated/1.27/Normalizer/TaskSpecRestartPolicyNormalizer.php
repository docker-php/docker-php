...
class TaskSpecRestartPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_27\\Model\\TaskSpecRestartPolicy') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\TaskSpecRestartPolicy) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\TaskSpecRestartPolicy();
