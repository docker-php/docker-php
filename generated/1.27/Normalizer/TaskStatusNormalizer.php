...
class TaskStatusNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_27\\Model\\TaskStatus') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_27\Model\TaskStatus) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_27\Model\TaskStatus();
        ...
        if (property_exists($data, 'ContainerStatus')) {
            $object->setContainerStatus($this->denormalizer->denormalize($data->{'ContainerStatus'}, 'Docker\\API\\V1_27\\Model\\TaskStatusContainerStatus', 'json', $context));
        }
