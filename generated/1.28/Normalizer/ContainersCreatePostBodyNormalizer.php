...
class ContainersCreatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_28\\Model\\ContainersCreatePostBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_28\Model\ContainersCreatePostBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_28\Model\ContainersCreatePostBody();
        ...
        if (property_exists($data, 'Healthcheck')) {
            $object->setHealthcheck($this->denormalizer->denormalize($data->{'Healthcheck'}, 'Docker\\API\\V1_28\\Model\\HealthConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'Volumes')) {
            $object->setVolumes($this->denormalizer->denormalize($data->{'Volumes'}, 'Docker\\API\\V1_28\\Model\\ConfigVolumes', 'json', $context));
        }
        ...
        if (property_exists($data, 'NetworkingConfig')) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data->{'NetworkingConfig'}, 'Docker\\API\\V1_28\\Model\\ContainersCreatePostBodyNetworkingConfig', 'json', $context));
        }
