...
class ExecIdJsonGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_28\\Model\\ExecIdJsonGetResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_28\Model\ExecIdJsonGetResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_28\Model\ExecIdJsonGetResponse200();
        ...
        if (property_exists($data, 'ProcessConfig')) {
            $object->setProcessConfig($this->denormalizer->denormalize($data->{'ProcessConfig'}, 'Docker\\API\\V1_28\\Model\\ProcessConfig', 'json', $context));
        }
