...
class ImageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_28\\Model\\Image' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_28\Model\Image) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_28\Model\Image();
        ...
        if (property_exists($data, 'ContainerConfig')) {
            $object->setContainerConfig($this->denormalizer->denormalize($data->{'ContainerConfig'}, 'Docker\\API\\V1_28\\Model\\Config', 'json', $context));
        }
        ...
        if (property_exists($data, 'RootFS')) {
            $object->setRootFS($this->denormalizer->denormalize($data->{'RootFS'}, 'Docker\\API\\V1_28\\Model\\ImageRootFS', 'json', $context));
        }
