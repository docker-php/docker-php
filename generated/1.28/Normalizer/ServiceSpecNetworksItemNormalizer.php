...
class ServiceSpecNetworksItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_28\\Model\\ServiceSpecNetworksItem') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_28\Model\ServiceSpecNetworksItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_28\Model\ServiceSpecNetworksItem();
