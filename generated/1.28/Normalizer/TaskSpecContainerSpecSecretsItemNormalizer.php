...
class TaskSpecContainerSpecSecretsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_28\\Model\\TaskSpecContainerSpecSecretsItem') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_28\Model\TaskSpecContainerSpecSecretsItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_28\Model\TaskSpecContainerSpecSecretsItem();
        if (property_exists($data, 'File')) {
            $object->setFile($this->denormalizer->denormalize($data->{'File'}, 'Docker\\API\\V1_28\\Model\\TaskSpecContainerSpecSecretsItemFile', 'json', $context));
        }
