...
class VolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($data instanceof \Docker\API\V1_28\Model\Volume) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_28\Model\Volume();
        ...
        if (property_exists($data, 'UsageData')) {
            $object->setUsageData($this->denormalizer->denormalize($data->{'UsageData'}, 'Docker\\API\\V1_28\\Model\\VolumeUsageData', 'json', $context));
        }
