...
class ContainerSummaryItemNetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_29\\Model\\ContainerSummaryItemNetworkSettings' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\ContainerSummaryItemNetworkSettings) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\ContainerSummaryItemNetworkSettings();
