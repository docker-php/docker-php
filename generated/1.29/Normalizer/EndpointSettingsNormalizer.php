...
class EndpointSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_29\\Model\\EndpointSettings') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\EndpointSettings) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\EndpointSettings();
        if (property_exists($data, 'IPAMConfig')) {
            $object->setIPAMConfig($this->denormalizer->denormalize($data->{'IPAMConfig'}, 'Docker\\API\\V1_29\\Model\\EndpointSettingsIPAMConfig', 'json', $context));
        }
