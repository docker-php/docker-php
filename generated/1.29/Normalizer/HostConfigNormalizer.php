...
class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_29\\Model\\HostConfig') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\HostConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\HostConfig();
        ...
        if (property_exists($data, 'LogConfig')) {
            $object->setLogConfig($this->denormalizer->denormalize($data->{'LogConfig'}, 'Docker\\API\\V1_29\\Model\\HostConfigLogConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'PortBindings')) {
            ...
            foreach ($data->{'PortBindings'} as $key => $value_9) {
                $values_9[$key] = $this->denormalizer->denormalize($value_9, 'Docker\\API\\V1_29\\Model\\HostConfigPortBindingsItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_11) {
                $values_11[] = $this->denormalizer->denormalize($value_11, 'Docker\\API\\V1_29\\Model\\Mount', 'json', $context);
            }
