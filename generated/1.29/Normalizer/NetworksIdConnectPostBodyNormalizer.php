...
class NetworksIdConnectPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_29\\Model\\NetworksIdConnectPostBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\NetworksIdConnectPostBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\NetworksIdConnectPostBody();
        if (property_exists($data, 'Container')) {
            $object->setContainer($data->{'Container'});
        }
        if (property_exists($data, 'EndpointConfig')) {
            $object->setEndpointConfig($this->denormalizer->denormalize($data->{'EndpointConfig'}, 'Docker\\API\\V1_29\\Model\\EndpointSettings', 'json', $context));
        }
