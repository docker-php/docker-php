...
class PluginNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_29\\Model\\Plugin' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\Plugin) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\Plugin();
        ...
        if (property_exists($data, 'Settings')) {
            $object->setSettings($this->denormalizer->denormalize($data->{'Settings'}, 'Docker\\API\\V1_29\\Model\\PluginSettings', 'json', $context));
        }
        if (property_exists($data, 'PluginReference')) {
            $object->setPluginReference($data->{'PluginReference'});
        }
        if (property_exists($data, 'Config')) {
            $object->setConfig($this->denormalizer->denormalize($data->{'Config'}, 'Docker\\API\\V1_29\\Model\\PluginConfig', 'json', $context));
        }
