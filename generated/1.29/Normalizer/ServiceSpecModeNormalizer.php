...
class ServiceSpecModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_29\\Model\\ServiceSpecMode') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\ServiceSpecMode) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\ServiceSpecMode();
        if (property_exists($data, 'Replicated')) {
            $object->setReplicated($this->denormalizer->denormalize($data->{'Replicated'}, 'Docker\\API\\V1_29\\Model\\ServiceSpecModeReplicated', 'json', $context));
        }
