...
class ServiceUpdateStatusNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_29\\Model\\ServiceUpdateStatus') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\ServiceUpdateStatus) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\ServiceUpdateStatus();
