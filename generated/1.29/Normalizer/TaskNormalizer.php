...
class TaskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_29\\Model\\Task' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\Task) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\Task();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_29\\Model\\TaskSpec', 'json', $context));
        }
        ...
        if (property_exists($data, 'Status')) {
            $object->setStatus($this->denormalizer->denormalize($data->{'Status'}, 'Docker\\API\\V1_29\\Model\\TaskStatus', 'json', $context));
        }
