...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_29\\Model\\TaskSpecContainerSpec') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\TaskSpecContainerSpec) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\TaskSpecContainerSpec();
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Docker\\API\\V1_29\\Model\\Mount', 'json', $context);
            }
        ...
        if (property_exists($data, 'DNSConfig')) {
            $object->setDNSConfig($this->denormalizer->denormalize($data->{'DNSConfig'}, 'Docker\\API\\V1_29\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        }
        if (property_exists($data, 'Secrets')) {
            $values_7 = [];
            foreach ($data->{'Secrets'} as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Docker\\API\\V1_29\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
