...
class TaskSpecPlacementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_29\\Model\\TaskSpecPlacement' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\TaskSpecPlacement) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\TaskSpecPlacement();
        ...
        if (property_exists($data, 'Preferences')) {
            ...
            foreach ($data->{'Preferences'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_29\\Model\\TaskSpecPlacementPreferencesItem', 'json', $context);
            }
