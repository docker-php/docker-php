...
class VolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_29\\Model\\Volume' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_29\Model\Volume) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_29\Model\Volume();
        ...
        if (property_exists($data, 'UsageData')) {
            $object->setUsageData($this->denormalizer->denormalize($data->{'UsageData'}, 'Docker\\API\\V1_29\\Model\\VolumeUsageData', 'json', $context));
        }
