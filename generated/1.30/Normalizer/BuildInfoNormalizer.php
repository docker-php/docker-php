...
class BuildInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_30\\Model\\BuildInfo') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\BuildInfo) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\BuildInfo();
        ...
        if (property_exists($data, 'errorDetail')) {
            $object->setErrorDetail($this->denormalizer->denormalize($data->{'errorDetail'}, 'Docker\\API\\V1_30\\Model\\ErrorDetail', 'json', $context));
        }
