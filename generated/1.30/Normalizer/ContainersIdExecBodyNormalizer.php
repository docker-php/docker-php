...
class ContainersIdExecBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_30\\Model\\ContainersIdExecBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\ContainersIdExecBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\ContainersIdExecBody();
