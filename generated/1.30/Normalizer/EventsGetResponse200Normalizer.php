...
class EventsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_30\\Model\\EventsGetResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\EventsGetResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\EventsGetResponse200();
        ...
        if (property_exists($data, 'Actor')) {
            $object->setActor($this->denormalizer->denormalize($data->{'Actor'}, 'Docker\\API\\V1_30\\Model\\EventsGetResponse200Actor', 'json', $context));
        }
