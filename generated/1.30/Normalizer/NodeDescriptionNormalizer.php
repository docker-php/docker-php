...
class NodeDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_30\\Model\\NodeDescription') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\NodeDescription) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\NodeDescription();
        if (property_exists($data, 'Hostname')) {
            $object->setHostname($data->{'Hostname'});
        }
        if (property_exists($data, 'Platform')) {
            $object->setPlatform($this->denormalizer->denormalize($data->{'Platform'}, 'Docker\\API\\V1_30\\Model\\NodeDescriptionPlatform', 'json', $context));
        }
        if (property_exists($data, 'Resources')) {
            $object->setResources($this->denormalizer->denormalize($data->{'Resources'}, 'Docker\\API\\V1_30\\Model\\NodeDescriptionResources', 'json', $context));
        }
        if (property_exists($data, 'Engine')) {
            $object->setEngine($this->denormalizer->denormalize($data->{'Engine'}, 'Docker\\API\\V1_30\\Model\\NodeDescriptionEngine', 'json', $context));
        }
        if (property_exists($data, 'TLSInfo')) {
            $object->setTLSInfo($this->denormalizer->denormalize($data->{'TLSInfo'}, 'Docker\\API\\V1_30\\Model\\SwarmSpec', 'json', $context));
        }
