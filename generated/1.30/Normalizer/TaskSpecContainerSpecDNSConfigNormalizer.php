...
class TaskSpecContainerSpecDNSConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_30\\Model\\TaskSpecContainerSpecDNSConfig') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\TaskSpecContainerSpecDNSConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\TaskSpecContainerSpecDNSConfig();
