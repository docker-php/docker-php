...
class TaskSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_30\\Model\\TaskSpec') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\TaskSpec) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\TaskSpec();
        if (property_exists($data, 'ContainerSpec')) {
            $object->setContainerSpec($this->denormalizer->denormalize($data->{'ContainerSpec'}, 'Docker\\API\\V1_30\\Model\\TaskSpecContainerSpec', 'json', $context));
        }
        if (property_exists($data, 'Resources')) {
            $object->setResources($this->denormalizer->denormalize($data->{'Resources'}, 'Docker\\API\\V1_30\\Model\\TaskSpecResources', 'json', $context));
        }
        if (property_exists($data, 'RestartPolicy')) {
            $object->setRestartPolicy($this->denormalizer->denormalize($data->{'RestartPolicy'}, 'Docker\\API\\V1_30\\Model\\TaskSpecRestartPolicy', 'json', $context));
        }
        if (property_exists($data, 'Placement')) {
            $object->setPlacement($this->denormalizer->denormalize($data->{'Placement'}, 'Docker\\API\\V1_30\\Model\\TaskSpecPlacement', 'json', $context));
        }
        ...
        if (property_exists($data, 'Networks')) {
            ...
            foreach ($data->{'Networks'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_30\\Model\\TaskSpecNetworksItem', 'json', $context);
            }
            $object->setNetworks($values);
        }
        if (property_exists($data, 'LogDriver')) {
            $object->setLogDriver($this->denormalizer->denormalize($data->{'LogDriver'}, 'Docker\\API\\V1_30\\Model\\TaskSpecLogDriver', 'json', $context));
        }
