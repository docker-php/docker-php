...
class TaskSpecPlacementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_30\\Model\\TaskSpecPlacement') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_30\Model\TaskSpecPlacement) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_30\Model\TaskSpecPlacement();
        ...
        if (property_exists($data, 'Preferences')) {
            ...
            foreach ($data->{'Preferences'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_30\\Model\\TaskSpecPlacementPreferencesItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'Platforms')) {
            ...
            foreach ($data->{'Platforms'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\API\\V1_30\\Model\\TaskSpecPlacementPlatformsItem', 'json', $context);
            }
