...
class ServiceResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_30\Model\Service[]|\Docker\API\V1_30\Model\ErrorResponse
     */
    public function serviceList($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_30\\Model\\Service[]', 'json');
            }
    ...
    /**
     * @param \Docker\API\V1_30\Model\ServicesCreatePostBody $body
     * @param array                                          $parameters {
     *
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_30\Model\ServicesCreatePostResponse201|\Docker\API\V1_30\Model\ErrorResponse
     */
    public function serviceCreate(\Docker\API\V1_30\Model\ServicesCreatePostBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        $queryParam->setDefault('X-Registry-Auth', null);
        $queryParam->setHeaderParameters(['X-Registry-Auth']);
        $url     = '/v1.30/services/create';
        $url     = $url . ('?' . $queryParam->buildQueryString($parameters));
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_30\\Model\\ServicesCreatePostResponse201', 'json');
            }
    ...
    /**
     * @param string                                           $id         ID or name of service
     * @param \Docker\API\V1_30\Model\ServicesIdUpdatePostBody $body
     * @param array                                            $parameters {
     *
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_30\Model\ServiceUpdateResponse|\Docker\API\V1_30\Model\ErrorResponse
     */
    public function serviceUpdate($id, \Docker\API\V1_30\Model\ServicesIdUpdatePostBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_30\\Model\\ServiceUpdateResponse', 'json');
            }
            if ('400' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_30\\Model\\ErrorResponse', 'json');
            }
