...
class ContainersIdExecBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\ContainersIdExecBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\ContainersIdExecBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\ContainersIdExecBody();
