...
class DistributionNameJsonResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_31\\Model\\DistributionNameJsonResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\DistributionNameJsonResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\DistributionNameJsonResponse200();
        if (property_exists($data, 'Descriptor')) {
            $object->setDescriptor($this->denormalizer->denormalize($data->{'Descriptor'}, 'Docker\\API\\V1_31\\Model\\DistributionNameJsonResponse200Descriptor', 'json', $context));
        }
        if (property_exists($data, 'Platforms')) {
            $values = [];
            foreach ($data->{'Platforms'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_31\\Model\\DistributionNameJsonResponse200PlatformsItem', 'json', $context);
            }
