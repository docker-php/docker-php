...
class EndpointPortConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_31\\Model\\EndpointPortConfig' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\EndpointPortConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\EndpointPortConfig();
