...
class InfoResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_31\\Model\\InfoResponse200' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\InfoResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\InfoResponse200();
        ...
        if (property_exists($data, 'Plugins')) {
            $object->setPlugins($this->denormalizer->denormalize($data->{'Plugins'}, 'Docker\\API\\V1_31\\Model\\InfoResponse200Plugins', 'json', $context));
        }
        ...
        if (property_exists($data, 'RegistryConfig')) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data->{'RegistryConfig'}, 'Docker\\API\\V1_31\\Model\\InfoResponse200RegistryConfig', 'json', $context));
        }
