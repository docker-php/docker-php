...
class NetworkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\Network') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\Network) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\Network();
        ...
        if (property_exists($data, 'IPAM')) {
            $object->setIPAM($this->denormalizer->denormalize($data->{'IPAM'}, 'Docker\\API\\V1_31\\Model\\IPAM', 'json', $context));
        }
        ...
        if (property_exists($data, 'Containers')) {
            ...
            foreach ($data->{'Containers'} as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_31\\Model\\NetworkContainer', 'json', $context);
            }
