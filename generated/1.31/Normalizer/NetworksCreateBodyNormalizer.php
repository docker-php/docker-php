...
class NetworksCreateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\NetworksCreateBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\NetworksCreateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\NetworksCreateBody();
