...
class PluginConfigLinuxNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\PluginConfigLinux') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\PluginConfigLinux) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\PluginConfigLinux();
        ...
        if (property_exists($data, 'Devices')) {
            ...
            foreach ($data->{'Devices'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_31\\Model\\PluginDevice', 'json', $context);
            }
