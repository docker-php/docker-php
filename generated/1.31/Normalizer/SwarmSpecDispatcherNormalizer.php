...
class SwarmSpecDispatcherNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\SwarmSpecDispatcher') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\SwarmSpecDispatcher) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\SwarmSpecDispatcher();
