...
class SwarmSpecTaskDefaultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_31\\Model\\SwarmSpecTaskDefaults' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\SwarmSpecTaskDefaults) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\SwarmSpecTaskDefaults();
        if (property_exists($data, 'LogDriver')) {
            $object->setLogDriver($this->denormalizer->denormalize($data->{'LogDriver'}, 'Docker\\API\\V1_31\\Model\\SwarmSpecTaskDefaultsLogDriver', 'json', $context));
        }
