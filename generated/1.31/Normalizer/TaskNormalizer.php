...
class TaskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\Task) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\Task();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_31\\Model\\TaskSpec', 'json', $context));
        }
        ...
        if (property_exists($data, 'Status')) {
            $object->setStatus($this->denormalizer->denormalize($data->{'Status'}, 'Docker\\API\\V1_31\\Model\\TaskStatus', 'json', $context));
        }
