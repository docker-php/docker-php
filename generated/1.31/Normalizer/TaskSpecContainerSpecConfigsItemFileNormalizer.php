...
class TaskSpecContainerSpecConfigsItemFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\TaskSpecContainerSpecConfigsItemFile') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\TaskSpecContainerSpecConfigsItemFile) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\TaskSpecContainerSpecConfigsItemFile();
