...
class TaskSpecResourcesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_31\\Model\\TaskSpecResources' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\TaskSpecResources) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\TaskSpecResources();
        if (property_exists($data, 'Limits')) {
            $object->setLimits($this->denormalizer->denormalize($data->{'Limits'}, 'Docker\\API\\V1_31\\Model\\TaskSpecResourcesLimits', 'json', $context));
        }
        if (property_exists($data, 'Reservation')) {
            $object->setReservation($this->denormalizer->denormalize($data->{'Reservation'}, 'Docker\\API\\V1_31\\Model\\TaskSpecResourcesReservation', 'json', $context));
        }
