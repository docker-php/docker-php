...
class VolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_31\\Model\\Volume') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_31\Model\Volume) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_31\Model\Volume();
        ...
        if (property_exists($data, 'UsageData')) {
            $object->setUsageData($this->denormalizer->denormalize($data->{'UsageData'}, 'Docker\\API\\V1_31\\Model\\VolumeUsageData', 'json', $context));
        }
