...
class ConfigResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\Config[]|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function configList($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\Config[]', 'json');
            }
    ...
    /**
     * @param \Docker\API\V1_31\Model\ConfigsCreatePostBody $body
     * @param array                                         $parameters List of parameters
     * @param string                                        $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\ConfigsCreatePostResponse201|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function configCreate(\Docker\API\V1_31\Model\ConfigsCreatePostBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\ConfigsCreatePostResponse201', 'json');
            }
     ...
     * @param \Docker\API\V1_31\Model\ConfigSpec $body       The spec of the config to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [ConfigInspect endpoint](#operation/ConfigInspect) response values.
     * @param array                              $parameters {
     *
     ...
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function configUpdate($id, \Docker\API\V1_31\Model\ConfigSpec $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
