...
class ConfigResource extends Resource
{
    ...
    /**
     * @param \Docker\API\V1_31\Model\ConfigsCreateBody $body
     * @param array                                     $parameters List of parameters
     * @param string                                    $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\ConfigsCreateResponse201|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function configCreate(\Docker\API\V1_31\Model\ConfigsCreateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\ConfigsCreateResponse201', 'json');
            }
