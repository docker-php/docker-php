...
class NodeResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\Node[]|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function nodeList($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\Node[]', 'json');
            }
     ...
     * @param \Docker\API\V1_31\Model\NodeSpec $body
     * @param array                            $parameters {
     *
     ...
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function nodeUpdate($id, \Docker\API\V1_31\Model\NodeSpec $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
