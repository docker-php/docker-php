...
class SwarmResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\SwarmResponse200|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function swarmInspect($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\SwarmResponse200', 'json');
            }
    ...
    /**
     * @param \Docker\API\V1_31\Model\SwarmInitBody $body
     * @param array                                 $parameters List of parameters
     * @param string                                $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function swarmInit(\Docker\API\V1_31\Model\SwarmInitBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
    ...
    /**
     * @param \Docker\API\V1_31\Model\SwarmJoinBody $body
     * @param array                                 $parameters List of parameters
     * @param string                                $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function swarmJoin(\Docker\API\V1_31\Model\SwarmJoinBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\SwarmUnlockkeyResponse200|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function swarmUnlockkey($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\SwarmUnlockkeyResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\ErrorResponse', 'json');
            }
    ...
    /**
     * @param \Docker\API\V1_31\Model\SwarmUnlockBody $body
     * @param array                                   $parameters List of parameters
     * @param string                                  $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function swarmUnlock(\Docker\API\V1_31\Model\SwarmUnlockBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
