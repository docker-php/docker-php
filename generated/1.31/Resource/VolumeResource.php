...
class VolumeResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\VolumesResponse200|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function volumeList($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\VolumesResponse200', 'json');
            }
    ...
    /**
     * @param \Docker\API\V1_31\Model\VolumesCreateBody $volumeConfig Volume configuration
     * @param array                                     $parameters   List of parameters
     * @param string                                    $fetch        Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\Volume|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function volumeCreate(\Docker\API\V1_31\Model\VolumesCreateBody $volumeConfig, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_31\Model\VolumesPruneResponse200|\Docker\API\V1_31\Model\ErrorResponse
     */
    public function volumePrune($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\VolumesPruneResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_31\\Model\\ErrorResponse', 'json');
            }
