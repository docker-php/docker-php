...
class ContainersCreateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_32\\Model\\ContainersCreateBody' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\ContainersCreateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\ContainersCreateBody();
        ...
        if (property_exists($data, 'NetworkingConfig')) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data->{'NetworkingConfig'}, 'Docker\\API\\V1_32\\Model\\ContainersCreateBodyNetworkingConfig', 'json', $context));
        }
