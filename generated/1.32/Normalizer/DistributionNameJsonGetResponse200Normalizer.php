...
class DistributionNameJsonGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\DistributionNameJsonGetResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\DistributionNameJsonGetResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\DistributionNameJsonGetResponse200();
        if (property_exists($data, 'Descriptor')) {
            $object->setDescriptor($this->denormalizer->denormalize($data->{'Descriptor'}, 'Docker\\API\\V1_32\\Model\\DistributionNameJsonGetResponse200Descriptor', 'json', $context));
        }
        if (property_exists($data, 'Platforms')) {
            $values = [];
            foreach ($data->{'Platforms'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_32\\Model\\DistributionNameJsonGetResponse200PlatformsItem', 'json', $context);
            }
