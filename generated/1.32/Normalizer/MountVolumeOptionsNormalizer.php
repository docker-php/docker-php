...
class MountVolumeOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\MountVolumeOptions') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\MountVolumeOptions) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\MountVolumeOptions();
        ...
        if (property_exists($data, 'DriverConfig')) {
            $object->setDriverConfig($this->denormalizer->denormalize($data->{'DriverConfig'}, 'Docker\\API\\V1_32\\Model\\MountVolumeOptionsDriverConfig', 'json', $context));
        }
