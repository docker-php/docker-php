...
class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\NetworkSettings') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\NetworkSettings) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\NetworkSettings();
        ...
        if (property_exists($data, 'Ports')) {
            ...
            foreach ($data->{'Ports'} as $key => $value) {
                ...
                foreach ($value as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_32\\Model\\PortBinding', 'json', $context);
                }
                $values[$key] = $values_1;
            }
        ...
        if (property_exists($data, 'SecondaryIPAddresses')) {
            ...
            foreach ($data->{'SecondaryIPAddresses'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\API\\V1_32\\Model\\Address', 'json', $context);
            }
        ...
        if (property_exists($data, 'SecondaryIPv6Addresses')) {
            ...
            foreach ($data->{'SecondaryIPv6Addresses'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\API\\V1_32\\Model\\Address', 'json', $context);
            }
        ...
        if (property_exists($data, 'Networks')) {
            ...
            foreach ($data->{'Networks'} as $key_1 => $value_4) {
                $values_4[$key_1] = $this->denormalizer->denormalize($value_4, 'Docker\\API\\V1_32\\Model\\EndpointSettings', 'json', $context);
            }
