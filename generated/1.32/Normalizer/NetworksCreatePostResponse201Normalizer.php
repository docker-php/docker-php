...
class NetworksCreatePostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\NetworksCreatePostResponse201') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\NetworksCreatePostResponse201) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\NetworksCreatePostResponse201();
