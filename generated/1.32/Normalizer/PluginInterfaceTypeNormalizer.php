...
class PluginInterfaceTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_32\\Model\\PluginInterfaceType' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\PluginInterfaceType) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\PluginInterfaceType();
