...
class ServiceEndpointNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_32\\Model\\ServiceEndpoint' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\ServiceEndpoint) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\ServiceEndpoint();
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_32\\Model\\EndpointSpec', 'json', $context));
        }
        if (property_exists($data, 'Ports')) {
            $values = [];
            foreach ($data->{'Ports'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_32\\Model\\EndpointPortConfig', 'json', $context);
            }
        ...
        if (property_exists($data, 'VirtualIPs')) {
            ...
            foreach ($data->{'VirtualIPs'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_32\\Model\\ServiceEndpointVirtualIPsItem', 'json', $context);
            }
