...
class SwarmNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\Swarm') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\Swarm) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\Swarm();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_32\\Model\\SwarmSpec', 'json', $context));
        }
        ...
        if (property_exists($data, 'JoinTokens')) {
            $object->setJoinTokens($this->denormalizer->denormalize($data->{'JoinTokens'}, 'Docker\\API\\V1_32\\Model\\JoinTokens', 'json', $context));
        }
