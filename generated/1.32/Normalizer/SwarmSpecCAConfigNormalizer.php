...
class SwarmSpecCAConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\SwarmSpecCAConfig') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\SwarmSpecCAConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\SwarmSpecCAConfig();
        ...
        if (property_exists($data, 'ExternalCAs')) {
            ...
            foreach ($data->{'ExternalCAs'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\API\\V1_32\\Model\\SwarmSpecCAConfigExternalCAsItem', 'json', $context);
            }
