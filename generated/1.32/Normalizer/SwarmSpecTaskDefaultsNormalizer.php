...
class SwarmSpecTaskDefaultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\SwarmSpecTaskDefaults') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\SwarmSpecTaskDefaults) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\SwarmSpecTaskDefaults();
        if (property_exists($data, 'LogDriver')) {
            $object->setLogDriver($this->denormalizer->denormalize($data->{'LogDriver'}, 'Docker\\API\\V1_32\\Model\\SwarmSpecTaskDefaultsLogDriver', 'json', $context));
        }
