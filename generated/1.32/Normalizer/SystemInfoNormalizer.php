...
class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\SystemInfo) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\SystemInfo();
        ...
        if (property_exists($data, 'Plugins')) {
            $object->setPlugins($this->denormalizer->denormalize($data->{'Plugins'}, 'Docker\\API\\V1_32\\Model\\PluginsInfo', 'json', $context));
        }
        ...
        if (property_exists($data, 'RegistryConfig')) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data->{'RegistryConfig'}, 'Docker\\API\\V1_32\\Model\\RegistryServiceConfig', 'json', $context));
        }
        if (property_exists($data, 'GenericResources')) {
            $values_4 = [];
            foreach ($data->{'GenericResources'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Docker\\API\\V1_32\\Model\\GenericResourcesItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'Runtimes')) {
            ...
            foreach ($data->{'Runtimes'} as $key => $value_6) {
                $values_6[$key] = $this->denormalizer->denormalize($value_6, 'Docker\\API\\V1_32\\Model\\Runtime', 'json', $context);
            }
        ...
        if (property_exists($data, 'Swarm')) {
            $object->setSwarm($this->denormalizer->denormalize($data->{'Swarm'}, 'Docker\\API\\V1_32\\Model\\SwarmInfo', 'json', $context));
        }
        ...
        if (property_exists($data, 'ContainerdCommit')) {
            $object->setContainerdCommit($this->denormalizer->denormalize($data->{'ContainerdCommit'}, 'Docker\\API\\V1_32\\Model\\Commit', 'json', $context));
        }
        if (property_exists($data, 'RuncCommit')) {
            $object->setRuncCommit($this->denormalizer->denormalize($data->{'RuncCommit'}, 'Docker\\API\\V1_32\\Model\\Commit', 'json', $context));
        }
        if (property_exists($data, 'InitCommit')) {
            $object->setInitCommit($this->denormalizer->denormalize($data->{'InitCommit'}, 'Docker\\API\\V1_32\\Model\\Commit', 'json', $context));
        }
