...
class TaskSpecContainerSpecConfigsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_32\\Model\\TaskSpecContainerSpecConfigsItem') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_32\Model\TaskSpecContainerSpecConfigsItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_32\Model\TaskSpecContainerSpecConfigsItem();
        if (property_exists($data, 'File')) {
            $object->setFile($this->denormalizer->denormalize($data->{'File'}, 'Docker\\API\\V1_32\\Model\\TaskSpecContainerSpecConfigsItemFile', 'json', $context));
        }
