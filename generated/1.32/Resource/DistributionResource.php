...
class DistributionResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_32\Model\DistributionNameJsonGetResponse200|\Docker\API\V1_32\Model\ErrorResponse
     */
    public function distributionInspect($name, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_32\\Model\\DistributionNameJsonGetResponse200', 'json');
            }
