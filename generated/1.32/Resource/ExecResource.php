...
class ExecResource extends Resource
{
     ...
     * @param \Docker\API\V1_32\Model\ContainersIdExecBody $execConfig Exec configuration
     ...
     */
    public function containerExec($id, \Docker\API\V1_32\Model\ContainersIdExecBody $execConfig, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
     ...
     * @param \Docker\API\V1_32\Model\ExecIdStartBody $execStartConfig
     * @param array                                   $parameters      List of parameters
     * @param string                                  $fetch           Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_32\Model\ErrorResponse
     */
    public function execStart($id, \Docker\API\V1_32\Model\ExecIdStartBody $execStartConfig, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_32\Model\ExecIdJsonResponse200|\Docker\API\V1_32\Model\ErrorResponse
     */
    public function execInspect($id, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_32\\Model\\ExecIdJsonResponse200', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_32\\Model\\ErrorResponse', 'json');
            }
