...
class SecretResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_32\Model\Secret[]|\Docker\API\V1_32\Model\ErrorResponse
     */
    public function secretList($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_32\\Model\\Secret[]', 'json');
            }
    ...
    /**
     * @param \Docker\API\V1_32\Model\SecretsCreatePostBody $body
     * @param array                                         $parameters List of parameters
     * @param string                                        $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_32\Model\SecretsCreatePostResponse201|\Docker\API\V1_32\Model\ErrorResponse
     */
    public function secretCreate(\Docker\API\V1_32\Model\SecretsCreatePostBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_32\\Model\\SecretsCreatePostResponse201', 'json');
            }
     ...
     * @param \Docker\API\V1_32\Model\SecretSpec $body       The spec of the secret to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [SecretInspect endpoint](#operation/SecretInspect) response values.
     * @param array                              $parameters {
     *
     ...
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_32\Model\ErrorResponse
     */
    public function secretUpdate($id, \Docker\API\V1_32\Model\SecretSpec $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
