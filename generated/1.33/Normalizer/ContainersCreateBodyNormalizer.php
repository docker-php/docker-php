...
class ContainersCreateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_33\\Model\\ContainersCreateBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\ContainersCreateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\ContainersCreateBody();
        ...
        if (property_exists($data, 'NetworkingConfig')) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data->{'NetworkingConfig'}, 'Docker\\API\\V1_33\\Model\\ContainersCreateBodyNetworkingConfig', 'json', $context));
        }
