...
class ContainersIdJsonResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_33\\Model\\ContainersIdJsonResponse200') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\ContainersIdJsonResponse200) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\ContainersIdJsonResponse200();
        ...
        if (property_exists($data, 'State')) {
            $object->setState($this->denormalizer->denormalize($data->{'State'}, 'Docker\\API\\V1_33\\Model\\ContainersIdJsonResponse200State', 'json', $context));
        }
