...
class DistributionNameJsonResponse200DescriptorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_33\\Model\\DistributionNameJsonResponse200Descriptor') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\DistributionNameJsonResponse200Descriptor) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\DistributionNameJsonResponse200Descriptor();
