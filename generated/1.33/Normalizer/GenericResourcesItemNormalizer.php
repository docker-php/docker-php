...
class GenericResourcesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_33\\Model\\GenericResourcesItem') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\GenericResourcesItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\GenericResourcesItem();
        if (property_exists($data, 'NamedResourceSpec')) {
            $object->setNamedResourceSpec($this->denormalizer->denormalize($data->{'NamedResourceSpec'}, 'Docker\\API\\V1_33\\Model\\GenericResourcesItemNamedResourceSpec', 'json', $context));
        }
        if (property_exists($data, 'DiscreteResourceSpec')) {
            $object->setDiscreteResourceSpec($this->denormalizer->denormalize($data->{'DiscreteResourceSpec'}, 'Docker\\API\\V1_33\\Model\\GenericResourcesItemDiscreteResourceSpec', 'json', $context));
        }
