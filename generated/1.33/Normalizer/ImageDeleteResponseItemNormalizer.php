...
class ImageDeleteResponseItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_33\\Model\\ImageDeleteResponseItem' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\ImageDeleteResponseItem) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\ImageDeleteResponseItem();
