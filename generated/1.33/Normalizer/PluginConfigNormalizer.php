...
class PluginConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_33\\Model\\PluginConfig' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\PluginConfig) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\PluginConfig();
        ...
        if (property_exists($data, 'Interface')) {
            $object->setInterface($this->denormalizer->denormalize($data->{'Interface'}, 'Docker\\API\\V1_33\\Model\\PluginConfigInterface', 'json', $context));
        }
        ...
        if (property_exists($data, 'User')) {
            $object->setUser($this->denormalizer->denormalize($data->{'User'}, 'Docker\\API\\V1_33\\Model\\PluginConfigUser', 'json', $context));
        }
        if (property_exists($data, 'Network')) {
            $object->setNetwork($this->denormalizer->denormalize($data->{'Network'}, 'Docker\\API\\V1_33\\Model\\PluginConfigNetwork', 'json', $context));
        }
        if (property_exists($data, 'Linux')) {
            $object->setLinux($this->denormalizer->denormalize($data->{'Linux'}, 'Docker\\API\\V1_33\\Model\\PluginConfigLinux', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_33\\Model\\PluginMount', 'json', $context);
            }
        ...
        if (property_exists($data, 'Env')) {
            ...
            foreach ($data->{'Env'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\API\\V1_33\\Model\\PluginEnv', 'json', $context);
            }
            $object->setEnv($values_2);
        }
        if (property_exists($data, 'Args')) {
            $object->setArgs($this->denormalizer->denormalize($data->{'Args'}, 'Docker\\API\\V1_33\\Model\\PluginConfigArgs', 'json', $context));
        }
        if (property_exists($data, 'rootfs')) {
            $object->setRootfs($this->denormalizer->denormalize($data->{'rootfs'}, 'Docker\\API\\V1_33\\Model\\PluginConfigRootfs', 'json', $context));
        }
