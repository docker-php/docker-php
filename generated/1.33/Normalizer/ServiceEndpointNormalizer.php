...
class ServiceEndpointNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_33\\Model\\ServiceEndpoint' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\ServiceEndpoint) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\ServiceEndpoint();
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_33\\Model\\EndpointSpec', 'json', $context));
        }
        ...
        if (property_exists($data, 'VirtualIPs')) {
            ...
            foreach ($data->{'VirtualIPs'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\API\\V1_33\\Model\\ServiceEndpointVirtualIPsItem', 'json', $context);
            }
