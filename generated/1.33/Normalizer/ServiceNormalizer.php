...
class ServiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Docker\\API\\V1_33\\Model\\Service') {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\Service) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\Service();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Docker\\API\\V1_33\\Model\\ServiceSpec', 'json', $context));
        }
        if (property_exists($data, 'Endpoint')) {
            $object->setEndpoint($this->denormalizer->denormalize($data->{'Endpoint'}, 'Docker\\API\\V1_33\\Model\\ServiceEndpoint', 'json', $context));
        }
        if (property_exists($data, 'UpdateStatus')) {
            $object->setUpdateStatus($this->denormalizer->denormalize($data->{'UpdateStatus'}, 'Docker\\API\\V1_33\\Model\\ServiceUpdateStatus', 'json', $context));
        }
