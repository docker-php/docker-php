...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ('Docker\\API\\V1_33\\Model\\TaskSpecContainerSpec' !== $type) {
            return false;
        }
    ...
    {
        if ($data instanceof \Docker\API\V1_33\Model\TaskSpecContainerSpec) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\V1_33\Model\TaskSpecContainerSpec();
        ...
        if (property_exists($data, 'Privileges')) {
            $object->setPrivileges($this->denormalizer->denormalize($data->{'Privileges'}, 'Docker\\API\\V1_33\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Docker\\API\\V1_33\\Model\\Mount', 'json', $context);
            }
        ...
        if (property_exists($data, 'HealthCheck')) {
            $object->setHealthCheck($this->denormalizer->denormalize($data->{'HealthCheck'}, 'Docker\\API\\V1_33\\Model\\HealthConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'DNSConfig')) {
            $object->setDNSConfig($this->denormalizer->denormalize($data->{'DNSConfig'}, 'Docker\\API\\V1_33\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        }
        if (property_exists($data, 'Secrets')) {
            $values_7 = [];
            foreach ($data->{'Secrets'} as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Docker\\API\\V1_33\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'Configs')) {
            ...
            foreach ($data->{'Configs'} as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Docker\\API\\V1_33\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
