...
class DistributionResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_33\Model\DistributionNameJsonResponse200|\Docker\API\V1_33\Model\ErrorResponse
     */
    public function distributionInspect($name, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\DistributionNameJsonResponse200', 'json');
            }
