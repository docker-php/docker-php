...
class NetworkResource extends Resource
{
    ...
    /**
     * @param \Docker\API\V1_33\Model\NetworksCreateBody $networkConfig Network configuration
     * @param array                                      $parameters    List of parameters
     * @param string                                     $fetch         Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_33\Model\NetworksCreateResponse201|\Docker\API\V1_33\Model\ErrorResponse
     */
    public function networkCreate(\Docker\API\V1_33\Model\NetworksCreateBody $networkConfig, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\NetworksCreateResponse201', 'json');
            }
            if ('403' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\ErrorResponse', 'json');
            }
    ...
    /**
     * @param string                                        $id         Network ID or name
     * @param \Docker\API\V1_33\Model\NetworksIdConnectBody $container
     * @param array                                         $parameters List of parameters
     * @param string                                        $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_33\Model\ErrorResponse
     */
    public function networkConnect($id, \Docker\API\V1_33\Model\NetworksIdConnectBody $container, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
    ...
    /**
     * @param string                                           $id         Network ID or name
     * @param \Docker\API\V1_33\Model\NetworksIdDisconnectBody $container
     * @param array                                            $parameters List of parameters
     * @param string                                           $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|null|\Docker\API\V1_33\Model\ErrorResponse
     */
    public function networkDisconnect($id, \Docker\API\V1_33\Model\NetworksIdDisconnectBody $container, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @param string $fetch Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_33\Model\NetworksPruneResponse200|\Docker\API\V1_33\Model\ErrorResponse
     */
    public function networkPrune($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\NetworksPruneResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\ErrorResponse', 'json');
            }
