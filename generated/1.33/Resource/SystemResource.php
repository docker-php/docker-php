...
class SystemResource extends Resource
{
     ...
     *
     * @param \Docker\API\V1_33\Model\AuthConfig $authConfig Authentication to check
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Docker\API\V1_33\Model\SystemInfo|\Docker\API\V1_33\Model\ErrorResponse
     */
    public function systemInfo($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\SystemInfo', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Docker\\API\\V1_33\\Model\\ErrorResponse', 'json');
            }
