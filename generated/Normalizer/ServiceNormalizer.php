...
class ServiceNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        $dataCreatedAtString = $data->{'CreatedAt'};
        $dataCreatedAtString = explode(".", $dataCreatedAtString)[0]."UTC";
        
        $dataUpdatedAtString = $data->{'UpdatedAt'};
        ...
        if (property_exists($data, 'CreatedAt')) {
            $object->setCreatedAt(\DateTime::createFromFormat("Y-m-d\TH:i:sP", $dataCreatedAtString));
        }
        if (property_exists($data, 'UpdatedAt')) {
            $object->setUpdatedAt(\DateTime::createFromFormat("Y-m-d\TH:i:sP", $dataUpdatedAtString));
        }
